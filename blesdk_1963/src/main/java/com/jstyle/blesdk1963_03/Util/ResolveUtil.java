...
import com.jstyle.blesdk1963_03.model.DeviceBean;
...
public class ResolveUtil {
    ...
    public static short dataFromRGB(byte red, byte green, byte blue) {
        short data = 0;
    ...
    public static Map<String,Object> getAutoHeart(byte[] value) {
        ...
        autoHeart[7] = String.valueOf(type);
        ...
        mapData.put(DeviceKey.type, autoHeart[7]);
        return maps;
    }
    ...
    public static Map<String,Object> getActivityAlarm(byte[] value) {
        ...
        mapData.put(DeviceKey.Mode, open+"");
        return maps;
    }
     ...
     * @return
     */
    public static Map<String,Object> getBloodPressure(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.GetBlood_pressures);
        maps.put(DeviceKey.End,false);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        int count = 12;
        ...
        for (int i = 0; i < size; i++) {
            ...
            String date = "20"+ByteToHexString(value[3 + i * count]) + "."
                    ...
                    + ByteToHexString(value[6 + i * count]) + ":" + ByteToHexString(value[7 + i * count]) + ":" + ByteToHexString(value[8 + i * count]);
            hashMap.put(DeviceKey.Date, date);
            hashMap.put(DeviceKey.Blood_pressureheight, String.valueOf(getValue(value[9 + i * count], 0)));
            hashMap.put(DeviceKey.Blood_pressureLow, String.valueOf(getValue(value[10 + i * count], 0)));
            hashMap.put(DeviceKey.dataSource, getValue(value[11 + i * count], 0)==0?"Automatic Measurement":"Manual Measurement");
            list.add(hashMap);
        }
...
/*    public static Map<String,Object> getHistoryGpsData(byte[] value) {
    ...
    public static Map<String,Object> getTempDataer(byte[] value) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            hashMap.put(DeviceKey.automatic, String.valueOf(getValue(value[11 + i * count], 0)));
            list.add(hashMap);
        }
