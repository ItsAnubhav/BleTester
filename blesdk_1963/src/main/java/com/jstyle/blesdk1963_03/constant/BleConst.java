package com.jstyle.blesdk1963_03.constant;
...
public class BleConst {
   ...
   public static final String GetAutomaticHRMonitoring="16";
   public static final String SetAutomaticHRMonitoring="17";
   ...
   public static final String HealthStatusColorSwitchOnMainInterfaceWithMode="65";
   public static final String GetHealthStatusColorSwitchOnMainInterfaceWithMode="66";
   public static final String GetBlood_pressures="67";
   public static final String HealthPushWithTyp="68";
   ...
   public static final String ENTERECG="ENTERECG";
    ...
    //Patch 1791 BLE constants
   public static final String ECGPPG_Error="21";

   public static final String Ecg_heeart="18";
   public static final String ECGPPG="20";
   public static final String Gesture_recognition="22";
